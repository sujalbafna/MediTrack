    ...
    <header className="bg-indigo-600 text-white p-4 shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-6">
          ...
          <Link to="/inventory" className="hover:text-indigo-200 transition-colors">Inventory</Link>
          <Link to="/reports" className="hover:text-indigo-200 transition-colors">Reports</Link>
          <Link to="mailto:bafna3249@gmail.com" className="mr-4">Mail Us</Link>
          <button
